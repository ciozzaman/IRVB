	...
	for shrink_factor_x in [3]:
		...
		for shrink_factor_t in [14]:
			...
			for i_phantom_int,phantom_int in enumerate(phantom):
				...
				plt.savefig('/home/ffederic/work/irvb/MAST-U' + '/'+'stand_off_0.045_pinhole_6' + str(shot_number)+'_'+ binning_type +'_gridres'+str(grid_resolution)+'cm_L_curve_evolution'+'_radiator_scan.eps')
				plt.figure(11)
				...
				plt.savefig('/home/ffederic/work/irvb/MAST-U' + '/'+'stand_off_0.045_pinhole_6' + str(shot_number)+'_'+ binning_type +'_gridres'+str(grid_resolution)+'cm_L_curve_curvature_evolution'+'_radiator_scan.eps')
				plt.title(csv_file.name[-60:-28])
				# plt.pause(0.01)
				...
				ani.save('/home/ffederic/work/irvb/MAST-U' + '/'+'stand_off_0.045_pinhole_6' + str(shot_number)+'_'+ binning_type +'_gridres'+str(grid_resolution)+'cm_reconstruct_emissivity_bayesian_radiator_scan_output.mp4', fps=5*(30)/383, writer='ffmpeg',codec='mpeg4')
				# plt.pause(0.01)
				plt.close()
			...
			temp_save['stand_off_0.045_pinhole_6']['x_optimal_input_full_res_all'] = x_optimal_input_full_res_all
			temp_save['stand_off_0.045_pinhole_6']['phantom'] = phantom
			temp_save['stand_off_0.045_pinhole_6']['recompose_voxel_emissivity_out'] = recompose_voxel_emissivity_out
			temp_save['stand_off_0.045_pinhole_6']['x_optimal_out'] = x_optimal_out
			temp_save['stand_off_0.045_pinhole_6']['recompose_voxel_emissivity_input_all'] = recompose_voxel_emissivity_input_all
			temp_save['stand_off_0.045_pinhole_6']['i_t_new_out'] = i_t_new_out
			temp_save['stand_off_0.045_pinhole_6']['fitted_foil_power_in'] = fitted_foil_power_in
			temp_save['stand_off_0.045_pinhole_6']['fitted_foil_power_out'] = fitted_foil_power_out
			temp_save['stand_off_0.045_pinhole_6']['time_per_iteration'] = time_per_iteration
			np.savez_compressed(laser_to_analyse[:-4]+'_stand_off_0.045_pinhole_6_inverted_baiesian_test_export_radiator_scan',**temp_save)
