	...
	for shrink_factor_x in [3]:
		...
		for shrink_factor_t in [7]:
			...
			for i_phantom_int,phantom_int in enumerate(phantom):
				...
				plt.savefig('/home/ffederic/work/irvb/MAST-U' + '/'+'stand_off_0.060_pinhole_6' + str(shot_number)+'_'+ binning_type +'_gridres'+str(grid_resolution)+'cm_L_curve_evolution'+'_radiator_scan.eps')
				plt.figure(11)
				...
				plt.savefig('/home/ffederic/work/irvb/MAST-U' + '/'+'stand_off_0.060_pinhole_6' + str(shot_number)+'_'+ binning_type +'_gridres'+str(grid_resolution)+'cm_L_curve_curvature_evolution'+'_radiator_scan.eps')
				plt.title(csv_file.name[-60:-28])
				# plt.pause(0.01)
				...
				ani.save('/home/ffederic/work/irvb/MAST-U' + '/'+'stand_off_0.060_pinhole_6' + str(shot_number)+'_'+ binning_type +'_gridres'+str(grid_resolution)+'cm_reconstruct_emissivity_bayesian_radiator_scan_output.mp4', fps=5*(30)/383, writer='ffmpeg',codec='mpeg4')
				# plt.pause(0.01)
				plt.close()
			...
			# temp_save.allow_pickle = True
			temp_save = dict([])
			temp_save['stand_off_0.060_pinhole_6'] = dict([])
			temp_save['stand_off_0.060_pinhole_6']['x_optimal_input_full_res_all'] = x_optimal_input_full_res_all
			temp_save['stand_off_0.060_pinhole_6']['phantom'] = phantom
			temp_save['stand_off_0.060_pinhole_6']['recompose_voxel_emissivity_out'] = recompose_voxel_emissivity_out
			temp_save['stand_off_0.060_pinhole_6']['x_optimal_out'] = x_optimal_out
			temp_save['stand_off_0.060_pinhole_6']['recompose_voxel_emissivity_input_all'] = recompose_voxel_emissivity_input_all
			temp_save['stand_off_0.060_pinhole_6']['i_t_new_out'] = i_t_new_out
			temp_save['stand_off_0.060_pinhole_6']['fitted_foil_power_in'] = fitted_foil_power_in
			temp_save['stand_off_0.060_pinhole_6']['fitted_foil_power_out'] = fitted_foil_power_out
			temp_save['stand_off_0.060_pinhole_6']['time_per_iteration'] = time_per_iteration
			np.savez_compressed(laser_to_analyse[:-4]+'_stand_off_0.060_pinhole_6_inverted_baiesian_test_export_radiator_scan',**temp_save)
...
temp_save.allow_pickle = True
temp_save = dict(temp_save)
x_optimal_all = temp_save['stand_off_0.060_pinhole_6'].all()['x_optimal_all']
recompose_voxel_emissivity_all = temp_save['stand_off_0.060_pinhole_6'].all()['recompose_voxel_emissivity_all']
voxels_centre = temp_save['stand_off_0.060_pinhole_6'].all()['voxels_centre']
y_opt_all = temp_save['stand_off_0.060_pinhole_6'].all()['y_opt_all']
opt_info_all = temp_save['stand_off_0.060_pinhole_6'].all()['opt_info_all']
foil_power_residuals_simulated = temp_save['stand_off_0.060_pinhole_6'].all()['foil_power_residuals_simulated']
...
temp_save.allow_pickle = True
temp_save = dict(temp_save)
temp_save['stand_off_0.060_pinhole_6']['fitted_foil_power'] = fitted_foil_power
temp_save['stand_off_0.060_pinhole_6']['foil_power'] = foil_power
temp_save['stand_off_0.060_pinhole_6']['foil_power_residuals'] = foil_power_residuals
temp_save['stand_off_0.060_pinhole_6']['regolarisation_coeff'] = regolarisation_coeff
temp_save['stand_off_0.060_pinhole_6']['x_optimal'] = x_optimal
temp_save['stand_off_0.060_pinhole_6']['sigma_powernoback'] = sigma_powernoback
