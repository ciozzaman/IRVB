...
pathparams_BB='/home/ffederic/work/irvb/2021-12-07_window_multiple_search_for_parameters'
f = []
...
def function_a(index):
	...
	# for type_of_calibration in ['NUC_plate','BB_source_w/o_window']:
		...
		temp_BBrad_std = np.mean(temp_BBrad_std,axis=0)
		temp_diffusion_std = np.mean(temp_diffusion_std,axis=0)
		temp_timevariation_std = np.mean(temp_timevariation_std,axis=0)
		temp_powernoback_std = np.mean(temp_powernoback_std,axis=0)
		...
		dr_total_power = 40	# fixed at 50 so it's the same for all
		...
		full_saved_file_dict[type_of_calibration]['partial_BBrad']=partial_BBrad
		full_saved_file_dict[type_of_calibration]['partial_BBrad_std']=partial_BBrad_std
		full_saved_file_dict[type_of_calibration]['partial_diffusion']=partial_diffusion
		full_saved_file_dict[type_of_calibration]['partial_diffusion_std']=partial_diffusion_std
		full_saved_file_dict[type_of_calibration]['partial_timevariation']=partial_timevariation
		full_saved_file_dict[type_of_calibration]['partial_timevariation_std']=partial_timevariation_std
		full_saved_file_dict[type_of_calibration]['partial_BBrad_small']=partial_BBrad_small
		full_saved_file_dict[type_of_calibration]['partial_BBrad_std_small']=partial_BBrad_std_small
		full_saved_file_dict[type_of_calibration]['partial_diffusion_small']=partial_diffusion_small
		full_saved_file_dict[type_of_calibration]['partial_diffusion_std_small']=partial_diffusion_std_small
		full_saved_file_dict[type_of_calibration]['partial_timevariation_small']=partial_timevariation_small
		full_saved_file_dict[type_of_calibration]['partial_timevariation_std_small']=partial_timevariation_std_small
		full_saved_file_dict['laser_location']=[horizontal_loc,dhorizontal_loc,vertical_loc,dvertical_loc,dr]
		full_saved_file_dict[type_of_calibration]['negative_partial_BBrad_time_mean']=negative_partial_BBrad_time_mean
		full_saved_file_dict[type_of_calibration]['negative_partial_BBrad_time_std']=negative_partial_BBrad_time_std
		full_saved_file_dict[type_of_calibration]['negative_partial_BBrad_space_mean']=negative_partial_BBrad_space_mean
		full_saved_file_dict[type_of_calibration]['negative_partial_BBrad_space_std']=negative_partial_BBrad_space_std
		full_saved_file_dict[type_of_calibration]['negative_partial_diffusion_time_mean']=negative_partial_diffusion_time_mean
		full_saved_file_dict[type_of_calibration]['negative_partial_diffusion_time_std']=negative_partial_diffusion_time_std
		full_saved_file_dict[type_of_calibration]['negative_partial_diffusion_space_mean']=negative_partial_diffusion_space_mean
		full_saved_file_dict[type_of_calibration]['negative_partial_diffusion_space_std']=negative_partial_diffusion_space_std
		full_saved_file_dict[type_of_calibration]['negative_partial_timevariation_time_mean']=negative_partial_timevariation_time_mean
		full_saved_file_dict[type_of_calibration]['negative_partial_timevariation_time_std']=negative_partial_timevariation_time_std
		full_saved_file_dict[type_of_calibration]['negative_partial_timevariation_space_mean']=negative_partial_timevariation_space_mean
		full_saved_file_dict[type_of_calibration]['negative_partial_timevariation_space_std']=negative_partial_timevariation_space_std
		full_saved_file_dict[type_of_calibration]['power_vs_space_sampling']=power_vs_space_sampling
		full_saved_file_dict[type_of_calibration]['power_vs_time_sampling']=power_vs_time_sampling
