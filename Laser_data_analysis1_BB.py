...
def function_a(index):
	...
	for type_of_calibration in ['BB_source_w_window']:
		...
		for emissivity in emissivity_range:
			...
			if override == False:
				try:
					test = full_saved_file_dict[type_of_calibration]['emissivity='+str(emissivity)]['partial_BBrad']
					print(type_of_calibration + 'emissivity='+str(emissivity)+' skipped because data present')
					continue
				except:
					pass

			preamble_4_prints = preamble_4_prints_first +type_of_calibration + ' emissivity='+str(emissivity) +'\n'
			...
			laser_framerate /=2	# because of the 2 digitiser
			...
			ref_laser_temperature_minus_background_crop = np.mean(np.mean(laser_temperature_minus_background_crop,axis=0)[select_ref_time],axis=0)
			test = []
			...
			for i in range(len(laser_digitizer_ID)):
				if type_of_calibration == 'BB_source_w_window' or type_of_calibration == 'BB_source_w/o_window':
					if i==0:
						output1.append(coleval.calc_temp_to_power_BB_1(photon_flux_over_temperature_interpolator,laser_temperature_minus_background_crop[i],ref_temperature,time_partial[i],dx,laser_counts_filtered_std_crop[i],BB_proportional_crop[i],BB_proportional_std_crop[i],reference_background_std_crop[i],laser_temperature_std_crop[i],nan_ROI_mask,return_grid_laplacian=True))
					...
					output1.append(coleval.calc_temp_to_power_1(dx,dt,averaged_params[i],laser_counts_filtered_std_crop[i],averaged_errparams[i],1,1,laser_temperature_std_crop[i],laser_temperature_minus_background_crop[i],int_time*1e3,nan_ROI_mask,ref_temperature[i]))
			...
			temp_BBrad = np.mean(temp_BBrad,axis=0)
			...
			dr_total_power = 35	# fixed at 50 so it's the same for all
			...
			full_saved_file_dict[type_of_calibration]['emissivity='+str(emissivity)]['partial_BBrad']=partial_BBrad
			full_saved_file_dict[type_of_calibration]['emissivity='+str(emissivity)]['partial_BBrad_std']=partial_BBrad_std
			full_saved_file_dict[type_of_calibration]['emissivity='+str(emissivity)]['partial_diffusion']=partial_diffusion
			full_saved_file_dict[type_of_calibration]['emissivity='+str(emissivity)]['partial_diffusion_std']=partial_diffusion_std
			full_saved_file_dict[type_of_calibration]['emissivity='+str(emissivity)]['partial_timevariation']=partial_timevariation
			full_saved_file_dict[type_of_calibration]['emissivity='+str(emissivity)]['partial_timevariation_std']=partial_timevariation_std
			full_saved_file_dict[type_of_calibration]['emissivity='+str(emissivity)]['partial_BBrad_small']=partial_BBrad_small
			full_saved_file_dict[type_of_calibration]['emissivity='+str(emissivity)]['partial_BBrad_std_small']=partial_BBrad_std_small
			full_saved_file_dict[type_of_calibration]['emissivity='+str(emissivity)]['partial_diffusion_small']=partial_diffusion_small
			full_saved_file_dict[type_of_calibration]['emissivity='+str(emissivity)]['partial_diffusion_std_small']=partial_diffusion_std_small
			full_saved_file_dict[type_of_calibration]['emissivity='+str(emissivity)]['partial_timevariation_small']=partial_timevariation_small
			full_saved_file_dict[type_of_calibration]['emissivity='+str(emissivity)]['partial_timevariation_std_small']=partial_timevariation_std_small
			full_saved_file_dict[type_of_calibration]['emissivity='+str(emissivity)]['negative_partial_BBrad_time_mean']=negative_partial_BBrad_time_mean
			full_saved_file_dict[type_of_calibration]['emissivity='+str(emissivity)]['negative_partial_BBrad_time_std']=negative_partial_BBrad_time_std
			full_saved_file_dict[type_of_calibration]['emissivity='+str(emissivity)]['negative_partial_BBrad_space_mean']=negative_partial_BBrad_space_mean
			full_saved_file_dict[type_of_calibration]['emissivity='+str(emissivity)]['negative_partial_BBrad_space_std']=negative_partial_BBrad_space_std
			full_saved_file_dict[type_of_calibration]['emissivity='+str(emissivity)]['negative_partial_diffusion_time_mean']=negative_partial_diffusion_time_mean
			full_saved_file_dict[type_of_calibration]['emissivity='+str(emissivity)]['negative_partial_diffusion_time_std']=negative_partial_diffusion_time_std
			full_saved_file_dict[type_of_calibration]['emissivity='+str(emissivity)]['negative_partial_diffusion_space_mean']=negative_partial_diffusion_space_mean
			full_saved_file_dict[type_of_calibration]['emissivity='+str(emissivity)]['negative_partial_diffusion_space_std']=negative_partial_diffusion_space_std
			full_saved_file_dict[type_of_calibration]['emissivity='+str(emissivity)]['negative_partial_timevariation_time_mean']=negative_partial_timevariation_time_mean
			full_saved_file_dict[type_of_calibration]['emissivity='+str(emissivity)]['negative_partial_timevariation_time_std']=negative_partial_timevariation_time_std
			full_saved_file_dict[type_of_calibration]['emissivity='+str(emissivity)]['negative_partial_timevariation_space_mean']=negative_partial_timevariation_space_mean
			full_saved_file_dict[type_of_calibration]['emissivity='+str(emissivity)]['negative_partial_timevariation_space_std']=negative_partial_timevariation_space_std
			full_saved_file_dict[type_of_calibration]['emissivity='+str(emissivity)]['power_vs_space_sampling']=power_vs_space_sampling
			full_saved_file_dict[type_of_calibration]['emissivity='+str(emissivity)]['power_vs_time_sampling']=power_vs_time_sampling
			full_saved_file_dict[type_of_calibration]['emissivity='+str(emissivity)]['ref_temperature']=ref_temperature
			full_saved_file_dict[type_of_calibration]['emissivity='+str(emissivity)]['ref_temperature_std']=ref_temperature_std
			full_saved_file_dict[type_of_calibration]['emissivity='+str(emissivity)]['reference_background_temperature_crop']=reference_background_temperature_crop
			full_saved_file_dict[type_of_calibration]['emissivity='+str(emissivity)]['reference_background_temperature_std_crop']=reference_background_temperature_std_crop
