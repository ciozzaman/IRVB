...
# unknown int = 3	# int(8)
# unknown int = 3	# int(8)
# time in microseconds from camera startup = 0	# int(16)
...
if False:	# all of this is now in the coleval library
	def hex8_to_int(hex):
...
out = coleval.ats_to_dict(os.path.join(path,fileats))
