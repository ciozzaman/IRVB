...
for grid_resolution in [2]:
	...
	path_sensitivity = '/home/ffederic/work/analysis_scripts/sensitivity_matrix_res_2cm_foil_pixel_h_187_power_stand_off_0.06_pinhole_6'
	try:
	...
	for shrink_factor_x in [3]:
		...
		for shrink_factor_t in [7]:
			...
			plt.imshow(np.flip(np.flip(np.flip(np.transpose(recompose_voxel_emissivity_input,(1,0)),axis=1),axis=1),axis=0),'rainbow',extent=[grid_data_masked_crop[:,:,0].min(),grid_data_masked_crop[:,:,0].max(),grid_data_masked_crop[:,:,1].min(),grid_data_masked_crop[:,:,1].max()])
			plt.plot(_MASTU_CORE_GRID_POLYGON[:, 0], _MASTU_CORE_GRID_POLYGON[:, 1], 'k')
			...
			for i in range(len(time_full_res)):
				...
				fitted_foil_power_full_res_no_homo = (np.dot(sensitivities_reshaped,x_optimal_input_full_res[:-2])).reshape(selected_ROI_full_res.shape)
			...
			temp_save.allow_pickle = True
			temp_save = dict(temp_save)
			temp_save['stand_off_0.06_pinhole_6'] = dict([])
			temp_save['stand_off_0.06_pinhole_6']['temperature_evolution'] = temperature_evolution
			...
			counts_full_resolution_std = coleval.estimate_counts_std(counts_full_resolution)
			...
			averaged_BB_proportional_std_crop_binned = 1.1647691499440713e-17	* np.ones_like(temperature_minus_background_crop_binned[0])
			temp_ref_counts_std_crop_binned = 5.077188644392399	* np.ones_like(temperature_minus_background_crop_binned)
			...
			time_binned = coleval.proper_homo_binning_t(time_full_res,shrink_factor_t)
			...
			temp_save = dict(temp_save)
			temp_save['stand_off_0.06_pinhole_6'] = dict([])
			temp_save['stand_off_0.06_pinhole_6']['x_optimal_all'] = x_optimal_all
			temp_save['stand_off_0.06_pinhole_6']['recompose_voxel_emissivity_all'] = recompose_voxel_emissivity_all
			temp_save['stand_off_0.06_pinhole_6']['y_opt_all'] = y_opt_all
			temp_save['stand_off_0.06_pinhole_6']['opt_info_all'] = opt_info_all
			temp_save['stand_off_0.06_pinhole_6']['voxels_centre'] = voxels_centre
			# temp_save['stand_off_0.06_pinhole_6']['foil_power_residuals_simulated'] = foil_power_residuals_simulated

			temp_save['stand_off_0.06_pinhole_6']['i_t_new'] = i_t_new
			temp_save['stand_off_0.06_pinhole_6']['temperature_evolution'] = temperature_evolution
			temp_save['stand_off_0.06_pinhole_6']['temperature_evolution_with_noise'] = temperature_evolution_with_noise
			temp_save['stand_off_0.06_pinhole_6']['powernoback_full_orig'] = powernoback_full_orig
			temp_save['stand_off_0.06_pinhole_6']['sigma_powernoback_full'] = sigma_powernoback_full
			temp_save['stand_off_0.06_pinhole_6']['powernoback_full'] = powernoback_full
			temp_save['stand_off_0.06_pinhole_6']['powernoback_full_std'] = powernoback_full_std
			temp_save['stand_off_0.06_pinhole_6']['powernoback'] = powernoback
			temp_save['stand_off_0.06_pinhole_6']['time_binned'] = time_binned
			temp_save['stand_off_0.06_pinhole_6']['x_optimal_input_full_res_int_binned'] = x_optimal_input_full_res_int_binned
...
temp_save.allow_pickle = True
temp_save = dict(temp_save)
x_optimal_all = temp_save['stand_off_0.06_pinhole_6'].all()['x_optimal_all']
recompose_voxel_emissivity_all = temp_save['stand_off_0.06_pinhole_6'].all()['recompose_voxel_emissivity_all']
voxels_centre = temp_save['stand_off_0.06_pinhole_6'].all()['voxels_centre']
y_opt_all = temp_save['stand_off_0.06_pinhole_6'].all()['y_opt_all']
opt_info_all = temp_save['stand_off_0.06_pinhole_6'].all()['opt_info_all']
# foil_power_residuals_simulated = temp_save['stand_off_0.06_pinhole_6'].all()['foil_power_residuals_simulated']
powernoback_full_orig = temp_save['stand_off_0.06_pinhole_6'].all()['powernoback_full_orig']
sigma_powernoback_full = temp_save['stand_off_0.06_pinhole_6'].all()['sigma_powernoback_full']
grid_laplacian_masked_crop_scaled = grid_laplacian_masked_crop/((1e-2*grid_resolution)**2)
sigma_emissivity = 1e6	# this is completely arbitrary
selected_ROI_internal = selected_ROI.flatten()
x_optimal_input_full_res_int_binned = temp_save['stand_off_0.06_pinhole_6'].all()['x_optimal_input_full_res_int_binned']
...
plt.figure(figsize=(12,13))
# plt.scatter(np.mean(grid_data_masked_crop,axis=1)[:,0],np.mean(grid_data_masked_crop,axis=1)[:,1],c=x_optimal,s=100,marker='s',cmap='rainbow')
plt.imshow(np.flip(np.flip(np.flip(np.transpose(recompose_voxel_emissivity-recompose_voxel_emissivity_input_low_res,(1,0)),axis=1),axis=1),axis=0),'rainbow',extent=[grid_data_masked_crop[:,:,0].min(),grid_data_masked_crop[:,:,0].max(),grid_data_masked_crop[:,:,1].min(),grid_data_masked_crop[:,:,1].max()])
plt.plot(_MASTU_CORE_GRID_POLYGON[:, 0], _MASTU_CORE_GRID_POLYGON[:, 1], 'k')
plt.plot(FULL_MASTU_CORE_GRID_POLYGON[:, 0], FULL_MASTU_CORE_GRID_POLYGON[:, 1], 'k')
temp = np.abs(efit_reconstruction.time-time_full_binned_crop[i_t]).argmin()
try:
...
temp_save.allow_pickle = True
temp_save = dict(temp_save)
temp_save['stand_off_0.06_pinhole_6']['fitted_foil_power'] = fitted_foil_power
temp_save['stand_off_0.06_pinhole_6']['foil_power'] = foil_power
temp_save['stand_off_0.06_pinhole_6']['foil_power_residuals'] = foil_power_residuals
temp_save['stand_off_0.06_pinhole_6']['regolarisation_coeff'] = regolarisation_coeff
temp_save['stand_off_0.06_pinhole_6']['x_optimal'] = x_optimal
temp_save['stand_off_0.06_pinhole_6']['sigma_powernoback'] = sigma_powernoback
np.savez_compressed(laser_to_analyse[:-4]+'_inverted_baiesian_test_export',**temp_save)
