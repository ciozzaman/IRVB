...
def Load():
	...
	elif param_ext['Set display','Quantity'][:10] == 'first_pass' or param_ext['Set display','Quantity'][:11] == 'second_pass' or param_ext['Set display','Quantity'][:10] == 'third_pass':
